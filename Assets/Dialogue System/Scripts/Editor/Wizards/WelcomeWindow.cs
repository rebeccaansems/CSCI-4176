...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class WelcomeWindow : EditorWindow
    {
        ...
        [MenuItem("Window/Dialogue System/Welcome Window", false, -1)]
        ...
        private void DrawButtons()
        {
            ...
            try
            {
                ...
                EditorGUILayout.HelpBox("Welcome to the Dialogue System for Unity!\n\nThe buttons below are shortcuts to commonly-used functions. You can find even more in Window > Dialogue System.", MessageType.None);
                EditorWindowTools.DrawHorizontalLine();
                ...
                try
                {
                    ...
                    {
                        Application.OpenURL("http://pixelcrushers.com/dialogue_system/manual/html/how_to_get_started.html#quickStart5Minutes");
                    }
                    ...
                    {
                        Application.OpenURL("http://www.pixelcrushers.com/dialogue_system/manual/html/scripting.html");
                    }
